...
export const thermalOverviewMetrics: PerformanceSupportMetric[] = [
  { label: "CPU", value: "78 °C", detail: "Sensor pending", percent: 78 },
  { label: "GPU", value: "72 °C", detail: "Sensor pending", percent: 72 },
  { label: "System", value: "45 °C", detail: "Sensor pending", percent: 45 },
];

export interface PerformanceCoolingTelemetry {
  fanSpeedLabel: string;
  fanSpeedPercent: number;
}

export const performanceCoolingTelemetry: PerformanceCoolingTelemetry = {
  fanSpeedLabel: "2200 RPM",
  fanSpeedPercent: 70,
};
